...
import com.iainfo.tprojo.handlerException.AuthentificationFailed;
import com.iainfo.tprojo.model.Admin;
...
public class HibernateDao {
    ...
    public HashMap homeData(int elementPerPages ,  int numPages) throws Exception {
        ...
        String sql = "SELECT * FROM v_home OFFSET "+offset+" LIMIT "+ elementPerPages;
