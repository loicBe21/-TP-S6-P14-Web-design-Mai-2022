...
<head>
  ...
  <link href="<c:url value=" /resources/theme/css/jquery.mb.YTPlayer.min.css" />" media="all" rel="stylesheet"
  type="text/css">
            ...
            <form method="post" action="<%=request.getContextPath()%>/login">
              ...
              <div class="row">
                <div class="col-md-6 form-group">
                  ...
                  <input type="text" id="fname" class="form-control form-control-lg" name="username" value="user1">
                </div>
                <div class="col-md-6 form-group">
                  <label for="lname">password</label>
                  <input type="password" id="lname" class="form-control form-control-lg" name="password" value="123">
                </div>
              </div>
              <div class="row">
                <div class="col-12">
